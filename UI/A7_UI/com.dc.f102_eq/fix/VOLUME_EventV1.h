#ifndef VOLUME_EventV1_HEAD
#define VOLUME_EventV1_HEAD
#include "pub.h"
#include "BaseStateEventItem2.h"

#define SCRN2_VOLUME "SCRN2_VOLUME"
...
class VOLUME_EventV1 : public BaseStateEventItemV2 {
public:
	PNG_STRUCT pngs[39];
	virtual int getPngLength(){return 39;};
	TXT_STRUCT	texts[3];
	virtual int getTextLength(){return 3;};
	VOLUME_EventV1();
	...
	virtual char *getScreenName(){ return "VOLUME";};
	...
	void  _F_ONOFF(MSG_ZHW&msg);
#include "..\VOLUME_EventV1_extend.h"
